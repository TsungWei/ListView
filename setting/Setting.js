...
function(declare, BaseWidgetSetting, lang, array,on, _WidgetsInTemplateMixin, Select, LayerInfos,$)  {
  //declare 補上 _WidgetsInTemplateMixin,程式才可使用dojo方法
    ...
    setConfig: function(config){
      ...
      LayerInfos.getInstance(this.map, this.map.itemInfo)
		.then(lang.hitch(this, function(layerInfosObj) {
		 ...
		 /*array.forEach(options,lang.hitch(this,function(pOption){
			 var newOption=new Option(pOption.label, pOption.value);
			 this.layerSelect.add(newOption); 
		 }));*/
		 
	    this.own(on(this.layerSelect, "change", lang.hitch(this,function(value) {
